...
public:
  ...
  virtual QString fontColorYellowNormal() const;
  virtual QString fontColorYellowHover() const;
  virtual QString fontColorYellowPressed() const;
  virtual QString backgroundColorGray() const;
  virtual QString backgroundButtonColorGrayHover() const;
  virtual QString backgroundColorYellowNormal() const;
  virtual QString backgroundColorYellowHover() const;
  virtual QString backgroundColorYellowPressed() const;
  virtual QString backgroundColorYellowDisabled() const;
