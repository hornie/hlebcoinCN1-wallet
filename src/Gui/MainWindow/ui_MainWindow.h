...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/hleb"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutHLEBAction = new QAction(MainWindow);
        m_aboutHLEBAction->setObjectName(QStringLiteral("m_aboutHLEBAction"));
        m_aboutHLEBAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutHLEBAction);
        ...
        QObject::connect(m_aboutHLEBAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutHLEBAction->setText(QApplication::translate("MainWindow", "About HLEB", Q_NULLPTR));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND HLEB", Q_NULLPTR));
